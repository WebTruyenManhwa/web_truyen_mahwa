          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-3/4 md:pl-8">
              ...
              {chapters.length > 0 && (
                <div className="mt-6">
                  <Link
                    href={`/novel-series/${novel.slug}/${chapters[0].slug}`}
                    className="inline-block px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
                  >
                    Đọc từ đầu
                  </Link>
                  <Link
                    href={`/novel-series/${novel.slug}/${chapters[chapters.length - 1].slug}`}
                    className="inline-block px-6 py-3 bg-gray-700 text-white rounded-lg hover:bg-gray-600 transition-colors ml-4"
                  >
                    Đọc chương mới nhất
                  </Link>
                </div>
          ...
          <div className="bg-gray-800 rounded-lg overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 p-4">
              {chapters.map((chapter) => (
                <Link
                  key={chapter.id}
                  href={`/novel-series/${novel.slug}/${chapter.slug}`}
